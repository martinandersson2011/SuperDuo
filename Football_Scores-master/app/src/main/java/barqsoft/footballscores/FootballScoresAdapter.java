...
public class FootballScoresAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        holder.score.setText(FootballUtilities.getScores(cursor.getInt(COL_HOME_GOALS), cursor.getInt(COL_AWAY_GOALS)));
        holder.matchId = cursor.getDouble(COL_ID);
        holder.homeCrest.setImageResource(FootballUtilities.getTeamCrestByTeamName(cursor.getString(COL_HOME)));
        holder.awayCrest.setImageResource(FootballUtilities.getTeamCrestByTeamName(cursor.getString(COL_AWAY)));
        ...
        if (holder.matchId == detailMatchId) {
            ...
            matchDay.setText(FootballUtilities.getMatchDay(context, cursor.getInt(COL_MATCHDAY), cursor.getInt(COL_LEAGUE)));
            TextView league = (TextView) v.findViewById(R.id.league_textview);
            league.setText(FootballUtilities.getLeague(context, cursor.getInt(COL_LEAGUE)));
